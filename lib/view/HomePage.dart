                  ...
                  children: [
                    ...
                    AnimatedContainer(
                      ...
                      child: TextField(
                        ...
                        onSubmitted: (value) {
                          ApiHelper().getWeatherData(
                              "${homeProviderTrue!.txtSearch.text.isEmpty ? "Rajkot" : homeProviderTrue!.txtSearch.text}");
                        },
                      ),
                    ),
                    IconButton(
              ...
              Expanded(
                child: Container(
                  child: FutureBuilder<WeatherModel?>(
                    future: ApiHelper().getWeatherData(
                        "${homeProviderTrue!.txtSearch.text.isEmpty ? "Rajkot" : homeProviderTrue!.txtSearch.text}"),
                        ...
                        return Column(
                          children: [
                            ...
                            Container(
                              ...
                              child: Image.asset(
                                  "assets/image/morningweather.png"),
                            ),
                            SizedBox(
                              height: 1.h,
                            ),
